...
{
    DUMMY_BLOCK(""), LAND_BLOCK("Land Block"), ROAD_BLOCK("Road Block"), UTILITY_BLOCK("Utility Block"), LOTTERY_BLOCK(
            "Lottery Block"), JAIL_BLOCK("Jail Block"), GO_TO_JAIL_BLOCK("Go to Jail Block"), CHANCE_BLOCK(
                    "Chance Block"), COMMUNITY_BLOCK(
                            "Community Block"), CASH_PAYMENT_BLOCK("Cash Payment Block"), GO_BLOCK("Go Block");
    ...
    {
        return this.equals(CHANCE_BLOCK) || this.equals(COMMUNITY_BLOCK);
    }
